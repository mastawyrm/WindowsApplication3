Public Class Form1
    ...
    Private Sub browse_Click(sender As Object, e As EventArgs) Handles browse.Click
        ...
        If typeBox.SelectedIndex = 0 Then
            ...
            fileDlog.InitialDirectory = "\\msnaf01c\MSFC-ITS\Firewall System Management"
        End If
        ...
        If loadedFile IsNot Nothing Then
            If IPlistTab.Visible Then
                If allPortsBox.Checked Then
                    listSearch(IPlistBox.Lines.Reverse.ToArray, ANYcheck.Checked, subnetCheck.Checked, parentGroupCheck.Checked, grpExpandChk.Checked, resolve_check.Checked)
                Else
                    listSearch(IPlistBox.Lines.Reverse.ToArray, ANYcheck.Checked, subnetCheck.Checked, parentGroupCheck.Checked, grpExpandChk.Checked, resolve_check.Checked, portBox.Lines)
                End If
            End If
    ...
    Private Sub IPaddButton_Click(sender As Object, e As EventArgs) Handles IPaddButton.Click
        ...
        If output IsNot Nothing Then
            ...
            IPlistBox.AppendText(output + vbNewLine)
        End If
    End Sub
